...
\newcommand\CvPictureWidth{3.5cm}
...
Back to being a part of the \href{https://tuxcare.com}{TuxCare} team.
...
\begin{CvWorkplaceDescription}
Working at AWS Route 53.
Our work was focused on developing an internal DNS service, used across the
entire AWS.

\begin{itemize}[noitemsep]
  \item Deep dive into DNS.
  \item Some Java work.
  \item Support for 24/7 systems critical to the entire AWS infrastucture:
on-call shifts, etc.
  \item Lots of obtained knowledge about AWS services.
\end{itemize}
\end{CvWorkplaceDescription}
...
It's a technology that allows live-patching userspace Linux processes without
restarting them (mainly to get rid of security vulnerabilities).
I was a key developer of \href{https://tuxcare.com/live-patching-services/dbcare/}{DBcare},
