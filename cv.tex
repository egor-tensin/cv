...
\begin{CvWorkplaceDescription}
I was a member of a performance team, responsible for revealing, analyzing and
solving storage system performance issues, with the focus on process \& thread
synchronization issues.
This included developing specialized tools, using profilers, benchmarking, etc.

\begin{itemize}[noitemsep]
  \item Native Windows \& Linux development.
...
\begin{minipage}[t]{.5\linewidth}
  ...
  \begin{itemize}
    ...
    \item \textbf{Scripting}: GNU Bash, PowerShell, CMD
    \item \textbf{Version Control}: Git, Apache Subversion, TFS
