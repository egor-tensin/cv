...
Back to being a happy member of the \href{https://tuxcare.com}{TuxCare} team.
Still looking out for possible vulnerabilities in your services and
live-patching them out!

\begin{itemize}[noitemsep]
  \item Same stack as my previous stint.
  \begin{itemize}[noitemsep]
    \item C programming
...
\begin{CvWorkplaceDescription}
A stint in the Amazon Route 53 team.
An unsuccessful one, but I did learn a lot, about technology as well as myself.
\end{CvWorkplaceDescription}
